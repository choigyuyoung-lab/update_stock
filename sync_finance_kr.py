...
# ==============================================================================
# 2. 한국투자증권 + FDR + yfinance 다단계 재무/기술 지표 수집부
# ==============================================================================
def get_finance_data(
    ...
    # 배당수익률 포맷팅
    div_y = kis_val.get("dividend_yield")
    ...
    return {
        ...
        "현재가": curr_p,
        "PER": kis_val.get("per"),
        "추정PER": yf_cons.get("forward_per"),
        "PBR": kis_val.get("pbr"),
        "EPS": kis_val.get("eps"),
        "추정EPS": yf_cons.get("forward_eps"),
        "BPS": kis_val.get("bps"),
        "배당수익률": div_y,
        "52주 최고가": w52_h,
        "52주 최저가": w52_l,
        "업종PER": None,
        "목표주가": yf_cons.get("target_price"),
        "투자의견": yf_cons.get("opinion"),
        "직전고점": safe_float(quant.get("swing_high")),
        "직전저점": safe_float(quant.get("swing_low")),
        "200일선": safe_float(quant.get("ma200")),
        "60일선": safe_float(quant.get("ma_supply")),
        "수급선": safe_float(quant.get("ma_supply")),
        "추세": quant.get("trend"),
...
def build_finance_update_for_page(
    ...
    select_fields = ["추세", "스마트 가이드", "모멘텀 진단", "위험도 등급", "투자의견"]
